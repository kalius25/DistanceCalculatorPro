...
Một module đã Freeze thì:

Không đổi tên class.
Không đổi tên public method.
Không đổi kiểu trả về.
Không đổi dependency.
Không thêm chức năng ngoài trách nhiệm.
...
Security.
Performance rõ rệt.
DDD mới được phê duyệt.

Điều này giúp dự án ổn định hơn khi phát triển dài hạn.
...
Không có hàm nào quá 40–50 dòng.
...
Không cần viết docstring cho mọi helper private nếu tên hàm đã đủ rõ.

Điều này giúp mã nguồn gọn hơn.
